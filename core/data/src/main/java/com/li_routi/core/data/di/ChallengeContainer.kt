...
object ChallengeContainer {
    ...
    val deleteVerificationUseCase: DeleteVerificationUseCase by lazy {
        DeleteVerificationUseCase(repository)
    }
    ...
    val editVerificationUseCase: EditVerificationUseCase by lazy {
        EditVerificationUseCase(repository)
    }
}
