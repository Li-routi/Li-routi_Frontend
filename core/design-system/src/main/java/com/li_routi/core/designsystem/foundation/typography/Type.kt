...
data class LiroutiTypography(
    ...
    val heading2Bold: TextStyle = lirouti(18, 28, FontWeight.Bold),
    ...
    val body1Bold: TextStyle = lirouti(16, 24, FontWeight.Bold),
    ...
    val body3Bold: TextStyle = lirouti(13, 16, FontWeight.Bold),
